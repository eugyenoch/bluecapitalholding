...
if (isset($_POST['reg'])) {
  ...
  if ($pass === $cpass) {
    ...
    if (mysqli_num_rows($sql_check_email_exec) > 0) {
      ...
      if ($sqlC) {
        // Update the user referral Count 
        if($refUser) {
          $query = "INSERT INTO `referral`(`referral`, `user_referred_email`) VALUES ('$refUser', '$email')";
          $con->query($query);
        }
        $toast = "success";
        header("Refresh:1,url=preloader.php?fn=$fname&em=$email");
      } else {
        $toast = "fail";
      }
    }
    ...
    <div class="login-box-body sty1">
      ...
      <form action="<?= htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="regForm">
        ...
        <?php if (isset($_GET['ref'])) : ?>
          <div class="field-item">
            <div class="field-wrap">
              <input type="text" class="form-control sty1" name="ref" readonly placeholder="Referral Code (optional)" value="<?= $_GET['ref'] ?? "" ?>" title="Referral Code">
            </div>
          </div>
        <?php else : ?>
          <div class="field-item">
            <div class="field-wrap">
              <input type="text" class="form-control sty1" name="ref" placeholder="Referral Code (optional)" value="" title="Referral Code">
            </div>
          </div>
        <?php endif; ?>
        ...
        <div class="field-item">
          ...
          <div>
            <div class="col-xs-8">
              <div class="checkbox icheck">
                <label>
                  ...
                  I agree to the <a href="https://bluecapitalholding.com/docs/terms-of-use.php" title="View terms of use" target="_blank" rel="noopener noreferrer">Terms Of Use</a></label><br>
            ...
            <div class="col-xs-4 m-t-1">
              ...
              <button type="submit" class="btn btn-lg btn-block btn-flat" style="background:#FF880E; color:#fff; cursor:pointer;" name="reg">Sign Up</button>
            </div>
            <!-- /.col -->
          </div>
      </form>
