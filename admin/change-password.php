...
<title> Change Password | Bluecapital Holding</title>
...
<div class="login-box sty1">
  ...
  <div class="login-logo">
   <a href="#"><span class="lead cursive">Bluecapital<span class="orange">Holding</span><!-- <img src="dist/img/p2pdark.png" width="" height="" alt="Bluecapital Holding" title="Bluecapital Holding"> --></a>
  </div>
    ...
    <form action="<?php htmlentities($_SERVER['PHP_SELF']);?>" method="post" name="changePassword">
      <div class="form-group has-feedback">
        <input type="password" class="form-control sty1" placeholder="Password" name="pwd" pattern="" title="Choose secure passwords only" required><span class="note"></span>
