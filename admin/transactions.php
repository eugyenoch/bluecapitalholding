...
<div>     
 ...
 <td class="data-col dt-token">
     ...
     <span class="lead user-info text-success"><?php if(isset($status) && $status!==null){echo $status;}?></span> </td>
                            ...
                            <a href="user.php?at=<?= $txn; ?>" class="dt-type-sm badge badge-sq badge-outline badge-info badge-md">A</a>
                        </td>
      <td class="data-col dt-type">
                            <a href="user.php?dt=<?= $txn; ?>" class="dt-type-md"><span class='badge badge-outline badge-primary badge-md'>Delete</span></a>
                            <a href="user.php?dt=<?= $txn; ?>" class="dt-type-sm badge badge-sq badge-outline badge-primary badge-md">Del</a>
                        </td>
                                                                    </td>
                            </tr>
                        <?php }?>
