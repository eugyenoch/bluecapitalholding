                    ...
                    <div class="col-lg-6 col-6">
                        <div class="token-information card card-full-height" style="border-radius:20px;">
                            <div class="token-info">
                                ...
                                <div class="gaps-2x"></div>
                                <h5 class="token-info-sub"><?php if (isset($sql_count_active_exec) && $sql_count_active_exec !== null) {
                                                                echo $sql_count_active_exec;
                                                            } ?></h5>
                            </div>
                        </div>
                        <!-- .card -->
                                ...
                                <div class="token-balance token-balance-s2">
                                    ...
                                    <ul class="token-balance-list row">
                                        <li class="token-balance-sub col-md-12 col-lg-6 mb-3" hidden><?php
                                                                                                        foreach ($sql_withdraw_exec as $withdraw_info) {
                                                                                                            extract($withdraw_info); ?>
                                                <span class="lead"><?php if (isset($withdraw_info['wstatus']) && $withdraw_info['wstatus'] === "approved") {
                                                                                                            } ?></span>
                                                <span class="sub"><?php if (isset($withdraw_info['wstatus']) && $withdraw_info['wstatus'] === "approved") {
                                                                                                            } ?></span>
                                        ...
                                        <li class="token-balance-sub col-md-12 col-lg-6 mb-3">
                                            ...
                                            if ($r_depo_3) {
                                                if ($fund_info['currency'] === "BTC") {
                                                    echo $r_depo_3['cur'] . ' ' . $r_depo_3['rsum'] . ' <br>';
                                                }
                                            }
                                            ...
                                            if ($r_Flow_3) {
                                                echo $r_Flow_3['cur'] . ' ' . $r_Flow_3['rsum'] . ' ';
                                            }
                                            ...
                                            if ($r_bnb_3) {
                                                echo $r_bnb_3['cur'] . ' ' . $r_bnb_3['rsum'] . '<br>';
                                            }
                                            ...
                                            ?>
                                                    ...
                                                    <span></span>
                                            <?php } else {
                                                    echo "Total transactions will appear here";
                                                }
                                            } ?>
                                        </li>
                                    </ul>
                ...
                <div class="col-md-4 mt-2 mt-sm-0">
                    <div class="d-flex justify-content-between justify-content-md-end align-items-center guttar-25px pdt-0-5x pdb-0-5x">
                        <div class="copyright-text">
                            <p>
                                <center><small>©&nbsp;<?= date('Y'); ?>&nbsp;<a href="#"><span class="orange">Boldswap</span></a> | All rights reserved.&nbsp;
                                        <!-- Boldswap - The easiest place to invest bitcoin. -->Boldswap is a registered investment platform providing digital asset investment management services to individuals, lending and investment, multicurrency and multifunctional online platform based on blockchain technology.
                                    </small></center>
                            </p>
                        </div>
                    </div>
