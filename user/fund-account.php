...
$sql_starter_update = "INSERT INTO transaction(txn,user_email,package,amount,currency,duration,interest,status)VALUES('$stxn','$user_email','$package','$amount','$currency','$duration','$interest','pending')";
