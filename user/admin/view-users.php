...
<div>     
 ...
 <td class="data-col dt-token">
     ...
     <a href="user.php?vu=<?= $id_no; ?>"><button class="btn btn-danger">Delete</button></a> 
      <a href="user.php?vu=<?= $id_no; ?>" class="dt-type-sm"><span class="dt-type-sm badge badge-sq badge-outline badge-primary badge-sm">Del</span></a>
      </td>
                            </tr><?php }?>
...
<script type="text/javascript">
  toastr.info('View and manage registered members on this page','Info');
</script>
    </body>
    </html>
