...
<div class="container-fluid">
	<div class="row">
      ...
      <span class="note"><small>choose secure password only</small></span>
          ...
          <div class="checkbox icheck">
            <label>
              <input type="checkbox" name="agreement" required>
               I agree to the <a href="https://bluecapitalholding.com/terms-of-use.php" title="View terms of use" target="_blank" rel="noopener noreferrer">Terms Of Use</a></label><br>
