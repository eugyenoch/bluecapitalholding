    ...
    <div class="token-sales card">
        <div class="card-innr">
            ...
            <div class="token-rate-wrap row">
                ...
                style="font-weight: 500; color: #FFFFFF; text-decoration:none; font-size: 11px;">Bluecapital Holding</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-md-8">
                    <ul class="footer-links">
                        ...
                        <li><a href="https://bluecapitalholding.com/docs/terms-of-use.php">Terms & Conditions</a></li>
                    </ul>
                </div>
                <!-- .col -->
                <div class="col-md-4 mt-2 mt-sm-0">
                    <div class="d-flex justify-content-between justify-content-md-end align-items-center guttar-25px pdt-0-5x pdb-0-5x">
                        <div class="copyright-text">&copy; 2022 Bluecapital Holding</div>
                    </div>
                </div>
                <!-- .col -->
            </div>
